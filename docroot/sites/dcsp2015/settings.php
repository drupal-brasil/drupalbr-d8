...
if (!drupal_is_cli() && $_SERVER['HTTP_HOST'] == 'devdcsp2015.drupal.org.br' && strpos($_SERVER['SCRIPT_URL'],'/2015') !== 0) {
  header('Location: http://devdcsp2015.drupal.org.br/2015/',TRUE,301);
  die;
}

# Drupalcamp sp redirect
if (!drupal_is_cli() && $_SERVER['HTTP_HOST'] == 'saopaulo.drupalcamp.com.br' && strpos($_SERVER['SCRIPT_URL'],'/2015') !== 0) {
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalbrasil_dev_dcsp2015.inc'))
  require($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_prod_drupalbrasil_dev_dcsp2015.inc');
//</DDSETTINGS>
